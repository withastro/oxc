...
function walkJSXChild(pos, ast, visitors) {
  switch (ast.buffer[pos]) {
    ...
    case 6:
      ...
      return;
    case 7:
      walkBoxAstroComment(pos + 8, ast, visitors);
      return;
    default:
...
function walkAstroComment(pos, ast, visitors) {
  const visit = visitors[39];
  if (visit !== null) visit(new AstroComment(pos, ast));
}
...
function walkBoxAstroComment(pos, ast, visitors) {
  return walkAstroComment(ast.buffer.uint32[pos >> 2], ast, visitors);
}
